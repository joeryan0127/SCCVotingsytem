...
// $mail->Body = "<h4>Hey! $name, use this account to vote in SCO election.</h4><p> Username: $idno <br>Password: $password </p><br>
// Note: *Copy and paste the username and password below into your web browser <br>
//     <p>Thank you!</p><br>
// ";
...
<body>
    <div style='box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.5);border-radius: 5px;font-family:tahoma;width=50%'>
        ...
        <form action='send_function.php' method='get' enctype='multipart/form-data'>
            ...
            <button style='padding: 1em;width: 40%;max-width: 100%;cursor: pointer;font-size: 16px;font-weight: bold;background-color: #4B8B3B;border: none;border-radius: 5px;color: white;'>Vote Now</button>
        </form>
